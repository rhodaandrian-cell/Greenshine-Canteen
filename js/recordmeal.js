...
function updateMealPreview() {
  ...
  document.getElementById("meal-prev-deduction").textContent =
    "KES " + total;
  ...
  if (mealStudent) {
    ...
    document.getElementById("meal-prev-current").textContent =
  ...
  document.getElementById("meal-btn").disabled =
    !mealStudent || total === 0;
}
    ...
    '<div style="font-size:14px;line-height:1.8">' +
      ...
      '<div class="deduction-summary" style="margin-top:12px">' +
        ...
        '<div class="deduction-row total">' +
          ...
          '<span class="text-mono ' +
            (after >= 0 ? "text-success" : "text-danger") + '">' +
      ...
      '<div style="margin-top:14px;color:var(--muted);font-size:13px">' +
        'Did <strong style="color:var(--light)">' +
        mealStudent.name +
...
async function submitMeal() {
  ...
  try {
    ...
    // Update local state
    allTxHistory[mealStudent.admNo] =
      (allTxHistory[mealStudent.admNo] || 0) + 1;
